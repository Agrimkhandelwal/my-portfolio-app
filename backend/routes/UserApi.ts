...
// --- Profile Routes ---
router.get("/profile", async (req: Request, res: Response<IProfile | null | ErrorResponse>) => {
  try {
...
router.put("/profile", async (req: Request<{}, {}, IProfile>, res: Response<IProfile | ErrorResponse>) => {
    try {
...
// --- Project Routes ---
router.get("/projects", async (req: Request<{}, any, any, ProjectQuery>, res: Response<IProject[] | ErrorResponse>) => {
    try {
...
router.post("/projects", async (req: Request<{}, {}, IProject>, res: Response<IProject | ErrorResponse>) => {
    try {
...
router.put("/projects/:id", async (req: Request<{id: string}, {}, IProject>, res: Response<IProject | ErrorResponse>) => {
    try {
...
router.delete("/projects/:id", async (req: Request<{id: string}>, res: Response<{ message: string }>) => {
    try {
...
// --- Skill Routes ---
router.get("/skills", async (req: Request, res: Response<ISkill[] | ErrorResponse>) => {
    try {
...
router.get("/skills/top", async (req: Request, res: Response<ISkill[] | ErrorResponse>) => {
    try {
...
router.post("/skills", async (req: Request<{}, {}, ISkill>, res: Response<ISkill | ErrorResponse>) => {
    try {
...
router.put("/skills/:id", async (req: Request<{id: string}, {}, ISkill>, res: Response<ISkill | ErrorResponse>) => {
    try {
...
router.delete("/skills/:id", async (req: Request<{id: string}>, res: Response<{ message: string }>) => {
    try {
...
router.get("/experiences", async (req: Request, res: Response<IExperience[] | ErrorResponse>) => {
    try {
...
router.post("/experiences", async (req: Request<{}, {}, IExperience>, res: Response<IExperience | ErrorResponse>) => {
    try {
...
router.put("/experiences/:id", async (req: Request<{id: string}, {}, IExperience>, res: Response<IExperience | ErrorResponse>) => {
    try {
...
router.delete("/experiences/:id", async (req: Request<{id: string}>, res: Response<{ message: string }>) => {
    try {
...
router.get("/search", async (req: Request<{}, any, any, SearchQuery>, res: Response<any | ErrorResponse>) => {
    try {
        const { q } = req.query;
